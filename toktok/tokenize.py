...
class Tokenizer:
    """
    This is a stand-alone Python port of the tok-tok.pl originally from
    https://github.com/jonsafari/tok-tok/blob/master/tok-tok.pl

    Before this, it was a tokenizer in NLTK on
    https://github.com/nltk/nltk/blob/develop/nltk/tokenize/toktok.py
    """
    ...
    TOKTOK_REGEXES_1 = [NON_BREAKING, FUNKY_PUNCT_1,
